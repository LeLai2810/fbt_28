        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('message.reset_password') }}</div>
                    <div class="panel-body">
                        ...
                        @endif
                        {!! Form::open(['route' => 'password.email', 'aria-label' => trans('message.reset-password')]) !!}
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    {!! Form::submit(trans('message.reset_link'), ['class' => 'btn btn-primary']) !!}
                                </div>
                            </div>
                        {!! Form::close() !!}
                    </div>
